...
def select_best(data, covariates, c, int_measure, preprocessing=None, select='max', nclust_range=None, combined_data=False):
    ...
    :param covariates: dataset of covariates
    :type covariates: array-like
    :param c: clustering algorithm class.
    :type c: obj
    :param int_measure: internal measure function.
    :type int_measure: obj
    :param preprocessing: preprocessing method class
...
def select_best_bic_aic(data, covariates, c, preprocessing=None, score='bic', nclust_range=None, combined_data=False):
    """
    Function that selects the best number of clusters that minimizes BIC 
    ...
    :param combined_data: if True, only grey matter features will be adjusted for TIV.
        Otherwise, both grey and white matter features will be adjusted for the same set of covariates.
    :type combined_data: boolean value
    :return: BIC score and best number of clusters.
    :rtype: float, int
    """
